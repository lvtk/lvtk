     ...
     */
     ...
     protected:
       ...
       static LV2_State_Status _save(LV2_Handle                 instance,
                                     ...
                                     const LV2_Feature *const * features)
       {
         return reinterpret_cast<Derived*>(instance)->save
                                               (store, handle,flags,features);
       }
       ...
       static LV2_State_Status _restore(LV2_Handle                  instance,
                                        ...
                                        const LV2_Feature *const *  features)
       {
         return reinterpret_cast<Derived*>(instance)->restore
                                             (retrieve, handle,flags,features);
       }
